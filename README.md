...
此项目可以用于商业目的，但您必须标注出处！
由于戴尔较老型号的服务器仅支持TLS1.0加密，导致许多现代浏览器无法正常打开网页浏览器，为方便使用，我写了它来更简便的使用idrac
这是一个轻量级的idrac Web 控制台，用于通过 SSH 连接 Dell iDRAC，idrac的SSH端口不需要部署在公网即可方便的随时随地使用，并以更适合浏览器查看的方式展示结果。
