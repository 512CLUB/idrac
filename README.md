...
本项目可用于商业用途，但您必须提供正确的署名！

由于旧款戴尔服务器只支持 TLS 1.0 加密，许多现代浏览器已无法正确打开 iDRAC 网页界面。为了更方便使用，我创建了这个工具，方便访问 iDRAC。

这是一款轻量级网页控制台，可通过SSH连接戴尔iDRAC。iDRAC SSH端口无需暴露在公共互联网中，方便随时随地使用，同时以更适合浏览器查看的方式显示结果。
